...
#    $Revision: 1248 $
#    $Author: tkeffer $
#    $Date: 2013-07-10 00:31:58 -0400 (Wed, 10 Jul 2013) $
#
...
class Simulator(weewx.abstractstation.AbstractStation):
    ...
    def __init__(self, **stn_dict):
        ...
        self.observations = {'outTemp'    : Observation(magnitude=20.0,  average= 50.0, period=24.0, phase_lag=14.0, start=start_ts),
                             ...
                             'windSpeed'  : Observation(magnitude=10.0,  average=  5.0, period=48.0, phase_lag=24.0, start=start_ts, absolute=True),
                             'windDir'    : Observation(magnitude=360.0, average=180.0, period=48.0, phase_lag= 0.0, start=start_ts),
                             'windGust'   : Observation(magnitude=12.0,  average=  6.0, period=48.0, phase_lag=24.0, start=start_ts, absolute=True),
...
class Observation(object):
    ...
    def __init__(self, magnitude=1.0, average=0.0, period=96.0, phase_lag=0.0, start=None, absolute=False):
    ...
    def value_at(self, time_ts):
        ...
        value = self.magnitude * math.cos(phase) + self.average
